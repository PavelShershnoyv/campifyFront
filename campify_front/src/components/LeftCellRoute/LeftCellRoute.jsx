...
import styles from './LeftCellRoute.module.scss';
import leftImage from '../../assets/img/LeftCellRoute.jpg';

export const LeftCellRoute = ({ 
  ...
  return (
    <div className={styles.leftCellRoute}>
      <div className={styles.imageContainer}>
        <img src={leftImage} alt={title} className={styles.image} />
      </div>
